...
var Util = {
  upperFirst: __webpack_require__(45),
  lowerFirst: __webpack_require__(46),
  isString: __webpack_require__(15),
  isNumber: __webpack_require__(13),
  isBoolean: __webpack_require__(47),
  ...
  deepMix: __webpack_require__(50),
  mix: __webpack_require__(20),
...
var Theme = __webpack_require__(43);
...
var Attr = __webpack_require__(54);
...
function (_Base) {
  ...
  _proto._mapping = function _mapping(data) {
    ...
    for (var i = 0, len = data.length; i < len; i++) {
      ...
      newRecord.points = record.points; // 閬垮厤
  ...
  _proto._getSnap = function _getSnap(scale, item, arr) {
    var i = 0;
    var values;
    var yField = this.getYScale().field; // 鍙犲姞鐨勭淮搴�
...
function () {
  ...
  _proto.parsePoint = function parsePoint(coord, position) {
    ...
    if (Util.isFunction(position)) {
      position = position(xScale, yScales); // position 蹇呴』鏄璞�
    } // 濡傛灉鏁版嵁鏍煎紡鏄� ['50%', '50%'] 鐨勬牸寮�
...
var mix = __webpack_require__(20);
...
var Plot = __webpack_require__(51);

var Util = __webpack_require__(0);

var Coord = __webpack_require__(52);

var Geom = __webpack_require__(6);

var ScaleController = __webpack_require__(61);

var AxisController = __webpack_require__(67);
...
var mix = __webpack_require__(60);
...
var StyleUtil = __webpack_require__(71);
...
var SHAPE_ATTRS = ['fillStyle', 'font', 'globalAlpha', 'lineCap', 'lineWidth', 'lineJoin', 'miterLimit', 'shadowBlur', 'shadowColor', 'shadowOffsetX', 'shadowOffsetY', 'strokeStyle', 'textAlign', 'textBaseline', 'lineDash', 'shadow' // 鍏煎鏀粯瀹濆皬绋嬪簭
];
...
var isType = __webpack_require__(87);
...
var catAuto = __webpack_require__(36);
...
if (!Util.isWx && !Util.isMy) {
  Hammer = __webpack_require__(143);
}
...
Core.Chart = __webpack_require__(18);
...
module.exports = {
  Position: __webpack_require__(55),
  Shape: __webpack_require__(56),
  Size: __webpack_require__(57),
...
var ColorUtil = __webpack_require__(59);
...
var numberAuto = __webpack_require__(64);
/**
 * 绾挎€у害閲�
 * @class Scale.Linear
 */
...
var AutoUtil = __webpack_require__(65);
...
var Util = {
  ...
  snapFactorTo: function snapFactorTo(v, arr, snapType) {
    ...
    var rst = v * factor; // 濡傛灉鍑虹幇娴偣鏁拌绠楅棶棰橈紝闇€瑕佸鐞嗕竴涓�
...
var Smooth = __webpack_require__(38);
...
var SizeMixin = __webpack_require__(40);
...
module.exports = {
  Stack: __webpack_require__(85),
  Dodge: __webpack_require__(89)
};
...
var isNil = __webpack_require__(88);
...
var Dodge = __webpack_require__(90);
...
var each = __webpack_require__(91);
...
/**
 * marker shapes锛寀sed for tooltip and legend
 */
var Util = __webpack_require__(0);
...
var TimeUtil = __webpack_require__(94);
...
function (_Abstract) {
  ...
  _proto._initDefaultCfg = function _initDefaultCfg() {
    ...
    this.startAngle = -Math.PI / 2; // start angle锛宨n radian
...
var TimeCat = __webpack_require__(111);
...
var Category = __webpack_require__(35);

var fecha = __webpack_require__(112);
...
function (_GuideBase) {
  ...
  _proto._initDefaultCfg = function _initDefaultCfg() {
    ...
    this.position = null;
    /**
      * alignment for horizontal direction锛宑an be 'left','center','right'
      * @type {String}
      */

    this.alignX = 'center';
    /**
      * alignment for vertical direction锛宑an be 'top', 'middle', 'bottom'
      * @type {String}
      */
...
function () {
  ...
  _proto.bindEvents = function bindEvents() {
    ...
    triggerOff && this._handleEvent(triggerOff, hideMethod, 'bind'); // TODO: 褰撶敤鎴风偣鍑� canvas 澶栫殑浜嬩欢鏃� tooltip 娑堝け
...
var Container = __webpack_require__(96);
...
module.exports = {
  init: function init(chart) {
    ...
    /**
     * 涓哄浘琛ㄦ坊鍔� guide
     * @return {GuideController} 杩斿洖 guide 鎺у埗鍣�
     */
...
var Animate = __webpack_require__(97);
...
function addAnimate(cache, shapes, canvas) {
  ...
  Util.each(updateShapes, function (updateShape) {
    ...
    var endState = diff(cacheAttrs, updateShape._attrs.attrs); // 鍒ゆ柇濡傛灉灞炴€х浉鍚岀殑璇濆氨涓嶈繘琛屽彉鎹�
...
function scaleInX(shape, animateCfg) {
  ...
  if (points[0].y - points[1].y > 0) { // 褰撻《鐐瑰湪闆剁偣涔嬩笅
    x = box.maxX;
  } else {
    x = box.minX;
  }
  ...
  updateCatScale: function updateCatScale(field, newValues, ticks, values, minIndex, maxIndex) {
    ...
    chart.scale(field, Util.mix({}, colDef, {
      ...
      scale: function scale(value) {
        ...
        var max;
        var percent;
        var currentIndex = values.indexOf(value); // 鍦ㄥ畬鏁存暟鎹泦涓殑绱㈠紩鍊�
...
module.exports = {
  _bindPress: function _bindPress() {
    ...
    if (tooltipController && tooltipController.enable) {
      chart.set('_closeTooltip', true); // 鐢ㄤ簬浜や簰鐨勭壒娈婃爣绀洪噺
  ...
  _handlePress: function _handlePress(e) {
    ...
    this.chart.set('_closeTooltip', false); // 鐢ㄤ簬浜や簰鐨勭壒娈婃爣绀洪噺
 ...
 * all
 */
var F2 = __webpack_require__(42);

__webpack_require__(100);

__webpack_require__(84);

__webpack_require__(93); // polar coordinate


__webpack_require__(109); // the axis for polar coordinate


__webpack_require__(110); // timeCat scale


__webpack_require__(137); // guide components
...
var ScrollBar = __webpack_require__(140);

var PieLabel = __webpack_require__(141);

F2.Animate = __webpack_require__(97); // register plugins
...
module.exports = {
  Text: __webpack_require__(117),
  Line: __webpack_require__(115),
  Arc: __webpack_require__(113),
  Rect: __webpack_require__(116),
  Html: __webpack_require__(114),
  Tag: __webpack_require__(118),
  Point: __webpack_require__(138),
  RegionFilter: __webpack_require__(139)
};
      ...
      children.map(function (c) {
        if (c.get('isShape')) {
          ...
          if (type === 'custom' || type === 'Custom') {
            // custom 绫诲瀷鐨� shape 浼氳嚜瀹氫箟缁樺埗 path 鐨勯€昏緫
...
function () {
  ...
  _proto.renderLabels = function renderLabels() {
    ...
    shapes.forEach(function (shape) {
      ...
      label.textGroup = textGroup; // 鍒ゆ柇鏂囨湰鐨勬柟鍚�
    ...
    if (skipOverlapLabels) {
      var lastLabel; // 瀛樺偍涓婁竴涓� label 瀵硅薄锛岀敤浜庢娴嬫枃鏈槸鍚﹂噸鍙�

      var labels = halves[1].concat(halves[0]); // 椤烘椂閽�
  ...
  _proto._drawLabelLine = function _drawLabelLine(label, maxLabelWidth) {
    ...
    if (!skipOverlapLabels && _inflection.y !== y) {
      // 灞曠ず鍏ㄩ儴鏂囨湰鏂囨湰浣嶇疆鍋氳繃璋冩暣
      if (_inflection.y < y) {
        // 鏂囨湰琚皟鏁翠笅鍘讳簡锛屽垯娣诲姞鎷愮偣杩炴帴绾�
  ...
  _proto._handleEvent = function _handleEvent(ev) {
    ...
    var x = canvasEvent.x,
        y = canvasEvent.y; // 鏌ユ壘琚偣鍑荤殑 label

    var clickedShape;

    for (var i = 0, len = drawnLabels.length; i < len; i++) {
      var shape = drawnLabels[i];
      var bbox = shape.getBBox(); // 閫氳繃鏈€灏忓寘鍥寸洅鏉ュ垽鏂嚮涓儏鍐�
...
module.exports = {
  ...
  PieSelect: __webpack_require__(144),
  IntervalSelect: __webpack_require__(145),
  Swipe: __webpack_require__(146),
  Pan: __webpack_require__(147),
  Pinch: __webpack_require__(148)
};
...
var FilterPlugin = __webpack_require__(130);

var MoveMixin = __webpack_require__(132);

var UpdateScaleMixin = __webpack_require__(131);
...
var PressTooltipMixin = __webpack_require__(133);
